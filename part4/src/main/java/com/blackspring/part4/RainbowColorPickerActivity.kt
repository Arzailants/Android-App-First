...
class RainbowColorPickerActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.red_button).setOnClickListener(colorPickerClickListener)
        findViewById<Button>(R.id.orange_button).setOnClickListener(colorPickerClickListener)
        findViewById<Button>(R.id.yellow_button).setOnClickListener(colorPickerClickListener)
        findViewById<Button>(R.id.green_button).setOnClickListener(colorPickerClickListener)
        findViewById<Button>(R.id.blue_button).setOnClickListener(colorPickerClickListener)
        findViewById<Button>(R.id.indigo_button).setOnClickListener(colorPickerClickListener)
        findViewById<Button>(R.id.violet_button).setOnClickListener(colorPickerClickListener)
